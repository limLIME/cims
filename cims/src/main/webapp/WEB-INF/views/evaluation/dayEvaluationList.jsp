...
$(document).ready(function(){
	var deptNo = ${evo.departmentVO.deptNo};
	if(deptNo!=4){
		location.href=""0.;
	}
...
$("#searchButton").click(function(){   
	 ...
	 location.href="evaluationSearchList.do?search="+search+"&searchVar="+searchVar+"&pageNo=1";
	});
});
</script>
  ...
  <div class="marginMain">
	...
	<table class="table table-striped table-advance table-hover">
		...
		<c:if test="${lvo.departmentVO.deptNo==sessionScope.evo.departmentVO.deptNo && today == lvo.evaluationDate}">
			<tr>
	...
	<input type="button" class="btn btn-info" value="Write" onclick="evaluationWrite()">
	</c:if>
	</div>
<p class="paging" align="center">
	...
	<a href="evaluation_dayEvaluation.do?pageNo=${pb.startPageOfPageGroup-1}">
	...
	<a href="evaluation_dayEvaluation.do?pageNo=${i}">${i}</a> 
	</c:when>
	<c:otherwise>
	${i}
	</c:otherwise>
	...
	<a href="evaluation_dayEvaluation.do?pageNo=${pb.endPageOfPageGroup+1}">
