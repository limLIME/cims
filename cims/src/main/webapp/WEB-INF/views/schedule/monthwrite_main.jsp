	...
	<section class="wrapper">
		<div class="marginDocWrite">
			<div class="content-panel">
					...
					<form action="${initParam.root}sch_monthWrite.do" method="post" id="MonthWriteForm">
						<table class="table">
							<thead>
								<tr>
							...
							<tbody>							
								<tr>
									...
									<td>
									<input type="text" class="datepicker" id="schDay" name="schDay"></td>
								</tr>
								<tr>
									<td><h4>Content</h4></td>
									<td>
										<textarea cols="30" rows="5" name="schContent" id="schContent" class="form-control"></textarea>
									</td>
								</tr>
							</tbody>
						</table>
						<div align="center">
							<input type="submit" class="btn btn-primary" value="register" id="registerBtn">
