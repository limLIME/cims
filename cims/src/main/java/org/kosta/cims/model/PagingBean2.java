...
public class PagingBean2 {
	 ...
	 * 페이지 당 보여줄 게시물 수 
	 */
	private int contentNumberPerPage=CommonConstants2.CONTENT_NUMBER_PER_PAGE;
	/**
	 * 페이지 그룹 당 페이지 수 
	 */
	private int pageNumberPerPageGroup=CommonConstants2.PAGE_NUMBER_PER_PAGEGROUP;
	/**
	 * 현재 db에 저장된 총 게시물 수 
	 */
	 ...
	 * @param nowPage
	 */
	public PagingBean2(int totalContents,int nowPage){
